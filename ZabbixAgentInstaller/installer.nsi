...
Name ZabbixAgent.NET

# Defines
!define REGKEY "SOFTWARE\$(^Name)"
!define VERSION 0.15
!define COMPANY ZabbixAgent
!define URL http://sourceforge.net/projects/zanet/
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER ZabbixAgent.NET
...
OutFile ZabbixAgent_NETInstaller.exe
InstallDir $PROGRAMFILES\ZabbixAgent.NET
CRCCheck on
XPStyle on
ShowInstDetails show
VIProductVersion 0.15.0.0
VIAddVersionKey ProductName ZabbixAgent.NET
...
Section -Main SEC0000
    ...
    nsSCM::Install /NOUNLOAD "ZabbixAgentNET" "ZabbixAgent.NET" 16 2 "$INSTDIR\ZabbixAgent.exe" "" "" "" ""
SectionEnd
...
Section /o -un.Main UNSEC0000
    ...
    !insertmacro DELETE_SMGROUP_SHORTCUT "ZabbixAgent Configuration"
...
Section -un.post UNSEC0001
    ...
    nsSCM::Stop /NOUNLOAD ZabbixAgentNET
    ; [name of service:startstop name]
    nsSCM::Remove /NOUNLOAD ZabbixAgentNET
